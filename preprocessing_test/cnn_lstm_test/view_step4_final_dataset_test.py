...
final_dataset_path = "processed_data/results_cnn_lstm_test/final_dataset_test.npz"
label_map_path = "processed_data/results_cnn_lstm_test/final_dataset_test_labels.json"

# Load dữ liệu
print("Đọc file final_dataset_test.npz ...")
